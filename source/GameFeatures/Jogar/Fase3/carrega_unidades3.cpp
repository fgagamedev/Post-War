...
for (int i=8;i<9;i++){
        ...
        caminho = "source/GameFeatures/Jogar/Fase3/images/helicoptero_ataque_azul_baixo.png";
        SDL_Surface *helicoptero_ataque_baixo = load_Image(caminho, screen);
        caminho = "source/GameFeatures/Jogar/Fase3/images/helicoptero_ataque_azul_cima.png";
